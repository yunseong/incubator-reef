 ...
 */
public final class GradientFunctionInput implements VortexCacheable {
  private CacheKey<ArrayList<Row>> trainingDataKey;
  private CacheKey<DenseVector> parameterVectorKey;

  private GradientFunctionInput() {
  }

  public GradientFunctionInput(final CacheKey<DenseVector> parameterVectorKey,
